...
local library = {design = getgenv().design == "Main" and "Main" or "Yanex", tabs = {}, draggable = true, flags = {}, title = "Yanex V.2", open = false, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = "Yanex V.2/Configs", fileext = ".json"}
